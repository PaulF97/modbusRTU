...
while True:
    ...
    if connexion == True:
        # writeOrNot = input("Do you want to write in a register ?\n")

        # if writeOrNot == "yes":
        #     registerType = input("in witch register you want to write ? (coils, or holding only) :\n ")
        ...
        if question == "ID":
            ending = client.write_registers(0,1,0x01)  # write to address 49849 of holding register
            test = client.read_holding_registers(0,10,0x01)
        elif question == "I/O":
